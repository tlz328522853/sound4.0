...
public class DicServiceImplTest {
	...
	public void update(){
		Dic dic = new Dic();
		dic.setDicId(4925490781702900L);
		dic.setName("中国亚洲");
		
		try {
			Map<String, Object> param = new HashMap<String, Object>();
			param.put("tenantId", 815333161191680L);
			dic = dicService.update(dic, param);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	...
	public void findByPid() throws Exception{
		dicService.findByPid(3610835821088761L, null);
	}
