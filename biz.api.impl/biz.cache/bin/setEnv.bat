...
rem	You must set the path variable UC_HOME and JAVA_HOME before running it!
rem	You MAY NOT use spaces in the path names
rem	JAVA_HOME is the full path name of the Java Software Development Kit's installation directory, such as D:\jdk1.5.0_19 
rem ================================

set UC_HOME=..
if not exist %JAVA_HOME%\lib\tools.jar goto NO_JAVA_HOME
...
:NO_JAVA_HOME
echo warnning: JAVA_HOME variable does not point to your J2SDK1.5
echo 	 	installation directory. Please edit your setEnv.bat script. 
pause
goto END
